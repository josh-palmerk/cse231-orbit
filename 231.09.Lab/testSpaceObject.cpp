 ...
 *    Garrin and Josh
 * Summary:
 *    The unit tests for Space Object
 ************************************************************************/
 ...
 * output:  zero
 *********************************************/
void TestSpaceObject::defaultConstructor()
{
    // setup
    // exercise
 ...
 *********************************************/
void TestSpaceObject::nonDefaultConstructor()
{
    // setup
    Position pos;
    pos.x = 1.3;
...
* output:  2.35, 4.57
*********************************************/
void TestSpaceObject::getPosition()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 2.35;
...
* output:  8.24, 9.63
*********************************************/
void TestSpaceObject::getVelocity()
{
    // setup
    SpaceObjectDerived so;
    so.velocity.dx = 8.24;
...
* output:  12.3
*********************************************/
void TestSpaceObject::getRadius()
{
    // setup
    SpaceObjectDerived so;
    so.radius = 12.3;
...
* output:  16
*********************************************/
void TestSpaceObject::getSecondsAlive()
{
    // setup
    SpaceObjectDerived so;
    so.secondsAlive = 16;
...
* output:  (54.56, 23.78)
*********************************************/
void TestSpaceObject::setPosition()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 22.22;
...
* output:  (28.73, 67.29)
*********************************************/
void TestSpaceObject::setVelocity()
{
    // setup
    SpaceObjectDerived so;
...
* output:  74.29
*********************************************/
void TestSpaceObject::setRadius()
{
    // setup
    SpaceObjectDerived so;
    so.radius = 48.62;
...
* output:  13
*********************************************/
void TestSpaceObject::setSecondsAlive()
{
    // setup
    SpaceObjectDerived so;
    so.secondsAlive = 6;
...
*********************************************/
void TestSpaceObject::applyGravityEarth()
{
    // setup
    SpaceObjectDerived so;
...
*********************************************/
void TestSpaceObject::applyGravityDifferentGravity()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 1000000;
...
*********************************************/
void TestSpaceObject::applyGravityDifferentCenter()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 1000000;
...
*********************************************/
void TestSpaceObject::applyGravityDifferentTimeStep()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 1000000;
...
*********************************************/
void TestSpaceObject::updatePositionNoMovement()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 15;
...
*********************************************/
void TestSpaceObject::updatePositionTwoAndHalfSeconds()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 10;
...
*********************************************/
void TestSpaceObject::rotatePositive()
{
    // setup
    SpaceObjectDerived so;
    so.angle.radians = 0;
...
*********************************************/
void TestSpaceObject::rotateNegative()
{
    // setup
    SpaceObjectDerived so;
...
*********************************************/
void TestSpaceObject::rotateNothing()
{
    // setup
    SpaceObjectDerived so;
...
*********************************************/
void TestSpaceObject::incrementSecondsAlive()
{
    // setup
    SpaceObjectDerived so;
    so.secondsAlive = 0;
...
*********************************************/
void TestSpaceObject::decrementSecondsAlive()
{
    // setup
    SpaceObjectDerived so;
    so.secondsAlive = 1;
...
*********************************************/
void TestSpaceObject::updateObjectOneSecond()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 1000000;
...
*********************************************/
void TestSpaceObject::updateObjectFiveSeconds()
{
    // setup
    SpaceObjectDerived so;
    so.position.x = 1000000;
